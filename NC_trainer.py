#Analogue to cond_trainer.py, this is the script that can be started in the background to train a prepared flow on prepared data, as specified in the NC_trainer folder.
#Used for models without conditions.
