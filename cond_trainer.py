#This is only ever needed for non API models and somewhat outdated/deprecated. It is kept here for reference.
#Script that can be started in the background to train a prepared flow on prepared data, as specified in the cond_trainer folder.
#See Base_Processor_Workflow.ipynb for more information on how to prepare the data and model.
